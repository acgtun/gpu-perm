...
__host__ __device__ int GetF2Seed(WORD_SIZE encode, SIZE_T len,
		WORD_SIZE * seed) {
...
__host__ __device__ SIZE_T GetKmer(const RefGenome * refGenome,
		SIZE_T nRefStart, SIZE_T kmerLen, InBits * r) {
