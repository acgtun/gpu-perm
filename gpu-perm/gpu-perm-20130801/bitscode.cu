...
__host__ __device__ void EncodeRead(const char * strRead, InBits * readsInBits, int len) {
...
__host__ __device__ void DecodeReadReverse(char * strRead, int readLen, const InBits * readsInBits) {
