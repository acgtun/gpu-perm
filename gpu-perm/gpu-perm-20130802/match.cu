...
__device__ void Mapping(const MapOpt mapOpt, const CReference * refGenome, const CHashTable * hashTable, CRead oneRead, CResult * oneResult) {
...
__device__ void MappingOneRead(const MapOpt mapOpt, const CReference * refGenome, const CHashTable * hashTable, CRead oneRead, CResult * oneResult) {
	oneResult->nRet = 0;
