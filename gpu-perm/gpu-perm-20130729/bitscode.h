...
__host__ __device__ void EncodeRead(const char * strReads, InBits * readsInBits,
		int len);
__host__ __device__ void DecodeRead(char * strReads, int readLen,
		const InBits * readsInBits);
__host__ __device__ void DecodeReadReverse(char * strReads, int readLen,
		const InBits * readsInBits);
...
__host__ __device__ char complimentBase(char nt);
