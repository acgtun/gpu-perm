...
void Reverse_Kernel(const CReadInStr * reads, CReadInStr * reads_rev, const SIZE_T & nReadsNum) {
...
int CMP(const CReadInStr * oneRead, const SIZE_T & nStartPos, const SIZE_T & index, const CReference * refGenome) {
	InBits ref; //+22
